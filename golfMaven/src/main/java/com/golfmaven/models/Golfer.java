...
public class Golfer {
    ...
    public Golfer(int golferId, String golferFirstName, String golferLastName,
                  String handedness, String gender, String teeBoxChoice, boolean hasHandicap) {
        this.golferId = golferId;
        this.golferFirstName = golferFirstName;
        this.golferLastName = golferLastName;
        this.handedness = handedness;
        this.gender = gender;
        this.teeBoxChoice = teeBoxChoice;
    ...
    public String getTeeBoxChoice() {
        return teeBoxChoice;
    }

    public void setTeeBoxChoice(String teeBoxChoice) {
        this.teeBoxChoice = teeBoxChoice;
    }
